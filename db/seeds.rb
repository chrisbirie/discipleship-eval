...
Disciple.create(first_name: 'Kirk', last_name: 'Jones', person_id: 1)
Disciple.create(first_name: 'Freddy', last_name: 'Gonzalez', person_id: 1)
Disciple.create(first_name: 'Peter', last_name: "O'Connor", person_id: 1)
Disciple.create(first_name: 'Angel', last_name: 'Garcia', person_id: 1)
Disciple.create(first_name: 'Jimmy', last_name: 'David', person_id: 2)
Disciple.create(first_name: 'James', last_name: 'Ferrell', person_id: 2)

Evaluation.create(disciple_id: 1)
Evaluation.create(disciple_id: 1)
Evaluation.create(disciple_id: 2)
Evaluation.create(disciple_id: 3)
Evaluation.create(disciple_id: 4)
Evaluation.create(disciple_id: 5)
Evaluation.create(disciple_id: 5)
Evaluation.create(disciple_id: 6)
Evaluation.create(disciple_id: 6)
